            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div class="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    ...
                    <div
                        ...
                        <div class="grid grid-cols-2 items-center">
                            <div>
                                <label class="font-semibold text-gray-900 dark:text-white">Nama Band</label>
                            </div>
                            <div>
                                <p class="text-gray-600 dark:text-white">: {{ $pesan->nama_band }}</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 items-center">
                            <div>
                                <label class="font-semibold text-gray-900 dark:text-white">Tanggal Pemesanan</label>
                            </div>
                            <div>
                                <p class="text-gray-600 dark:text-white">: {{ $pesan->tanggal_pemesanan}}</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 items-center">
                            <div>
                                <label class="font-semibold text-gray-900 dark:text-white">Jumlah Tiket</label>
                            </div>
                            <div>
                                <p class="text-gray-600 dark:text-white">: {{ $pesan->jumlah_tiket }}</p>
                            </div>
                        </div>
                        <div class="grid grid-cols-2 items-center">
                            <div>
