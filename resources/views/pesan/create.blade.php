...
<body>
        ...
        <nav
            ...
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <a href="index.php" class="flex items-center">
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Lifevent</span>
                </a>
            ...
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                <div class="form_content bg-gray-50 border border-gray-600 dark:bg-gray-900">
                    ...
                    <form action="{{ route('pesanan.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-5">
                            <div class="col-30">
                                <label for="nama_band" class="font-semibold text-gray-900 dark:text-white">Nama band</label>
                            </div>
                            <div class="col-70">
                                <select id="nama_band" name="nama_band" onchange="hargaTiket()"
                                    class="rounded-md border-gray-400 text-gray-600 dark:bg-gray-700 dark:border-gray-600 dark:text-white outline-none">
                                    <option selected="">Pilih Band</option>
                                    <option value="ndx">NDX</option>
                                    <option value="kahitna">kahitna</option>
                        ...
                        <div class="row mb-5">
                            <div class="col-30">
                                <label for="tanggal_pemesanan"
                                    class="font-semibold text-gray-900 dark:text-white">Tanggal Pemesanan</label>
                            </div>
                            <div class="col-70">
                        ...
                        <div class="row mb-5">
                            <div class="col-30">
                                <label for="jumlah_tiket"
                                    class="font-semibold text-gray-900 dark:text-white">Jumlah Tiket</label>
                            </div>
                            <div class="col-70">
                        ...
                        <div class="row">
                            <div class="flex items-center mb-5">
                                ...
                                <label for="remember"
                                    ...
                                    telah membaca, memahami, dan setuju berdasarkan syarat dan
                                    ketentuan yang
    ...
    <script>
        ...
        function hargaTiket() {
            ...
            const namaband = document.getElementById("nama_band").value;
            ...
            } else if (namaband == "kahitna") {
                hargaTiket.value = 160000;
            } else if (namaband == "noah") {
        ...
        $("#hitung").click(function() {
            ...
            var jumlah_tiket = parseInt($("#jumlah_tiket").val());
            var harga_tiket = parseInt($("#harga_tiket").val());
            // Variabel dan kondisional perhitungan
            var total_bayar = jumlah_tiket * harga_tiket;
